...
static const MMLEntityTable::Spec mml_entity_data[] =
{
    { "angzarr",                         "&#x0237C;"          },
    { "cirmid",                          "&#x02AEF;"          },
    { "cudarrl",                         "&#x02938;"          },
...
QString MMLEntityTable::entities() const
{
    QString result = "<!DOCTYPE math [\n";

    const MMLEntityTable::Spec *entity = mml_entity_data;
...
const MMLEntityTable::Spec *MMLEntityTable::search(const QString &value, const MMLEntityTable::Spec *from )
{
    const MMLEntityTable::Spec *entity = from;
    if ( entity == 0 )
